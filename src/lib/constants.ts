...
export const APPLICATION_STATUS_COLORS: Record<ApplicationStatus, string> = {
  SAVED: "bg-slate-100 text-slate-700 dark:bg-slate-500/15 dark:text-slate-300",
  ...
  ONLINE_ASSESSMENT: "bg-cyan-100 text-cyan-700 dark:bg-cyan-500/15 dark:text-cyan-300",
  RECRUITER_SCREEN: "bg-teal-100 text-teal-700 dark:bg-teal-500/15 dark:text-teal-300",
  TECHNICAL_INTERVIEW: "bg-amber-100 text-amber-700 dark:bg-amber-500/15 dark:text-amber-300",
  HIRING_MANAGER_INTERVIEW: "bg-orange-100 text-orange-700 dark:bg-orange-500/15 dark:text-orange-300",
  ONSITE_FINAL_ROUND: "bg-fuchsia-100 text-fuchsia-700 dark:bg-fuchsia-500/15 dark:text-fuchsia-300",
  OFFER: "bg-emerald-100 text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-300",
  REJECTED: "bg-red-100 text-red-700 dark:bg-red-500/15 dark:text-red-300",
  WITHDRAWN: "bg-neutral-100 text-neutral-500 dark:bg-neutral-500/10 dark:text-neutral-400",
};
